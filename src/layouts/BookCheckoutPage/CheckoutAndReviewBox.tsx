...
import { LeaveAReview } from "../Utills/LeaveAReview";

export const CheckoutAndReviewBox:React.FC<{book:BookModel | undefined,mobile:boolean,
    currentLoansCount:number,isAuthenticated:any,isCheckedOut:any,checkoutBook:any,
    ...
    function buttonRender(){
        if(props.isAuthenticated ){
            if(!props.isCheckedOut && props.currentLoansCount < 5){
                ...
                return (<p className="text-danger">Too many books chedked out.</p>)
            }
        }
